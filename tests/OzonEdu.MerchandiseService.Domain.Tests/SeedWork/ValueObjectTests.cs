...
namespace OzonEdu.MerchandiseService.Domain.Tests.SeedWork
{
    public class ValueObjectTests
    {
        ...
        public void Equals_EqualValueObjects_ReturnsTrue_Test(ValueObject instanceA, ValueObject instanceB, string reason)
        {
            // Act
        ...
        public void Equals_NonEqualValueObjects_ReturnsFalse_Test(ValueObject instanceA, ValueObject instanceB, string reason)
        {
            // Act
            var result = EqualityComparer<ValueObject>.Default.Equals(instanceA, instanceB);
